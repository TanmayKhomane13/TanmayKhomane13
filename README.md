...
- ❤️ **[Heart Attack Risk Predictor](https://github.com/TanmayKhomane13/Heart-Attack-Risk-Predictor)**: Logistic regression model using 9 medical features; includes probability output, health advice, and visualizations.
